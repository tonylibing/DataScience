...
def smallTrainFFM(args):
    ...
    param = {'task': 'binary', 'lr': 0.02, 'lambda': 0.001, 'metric': 'auc', 'opt': 'sgd', 'epoch':1000, 'k': 5,'stop_window':3,
...
def trainFFM(args):
    ...
    #          'alpha':0.002, 'beta':0.8, 'lambda_1':0.001, 'lambda_2': 1.0,'fold': 5}
    param = {'task': 'binary', 'lr': 0.015, 'lambda': 0.001, 'metric': 'auc', 'opt': 'ftrl', 'epoch': 10, 'k': 3,'fold':10,
